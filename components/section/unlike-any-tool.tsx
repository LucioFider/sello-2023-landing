...
export const UnlikeAnyTool = () => (
  <div className="text-white">
    ...
    <div className="h-[48rem] overflow-hidden md:h-auto md:overflow-auto">
      <div className="flex snap-x snap-mandatory gap-6 px-8 pb-12 overflow-x-auto md:flex-wrap md:overflow-hidden">
        ...
        <div className="overflow-hidden relative flex min-h-[48rem] w-full shrink-0 snap-center flex-col items-center justify-end rounded-[4.8rem] border border-transparent-white bg-glass-gradient p-8 text-center md:basis-[calc(33.33%-12px)] md:p-14">
        ...
        <div className="overflow-hidden group relative flex min-h-[48rem] w-full shrink-0 snap-center flex-col items-center justify-end rounded-[4.8rem] border border-transparent-white bg-glass-gradient p-8 text-center md:basis-[calc(33.33%-12px)] md:p-14">
          <div className="w-[130%] pointer-events-none absolute top-[-8rem]">
